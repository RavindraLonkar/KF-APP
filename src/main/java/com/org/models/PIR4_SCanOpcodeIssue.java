...
@Entity
@javax.persistence.Table(name = "PIR4_Scanopcodeissue")
public class PIR4_SCanOpcodeIssue {
	...
	private long pi_ID;
	@Column
	private String pi_Variety;
	@Column
	private String pi_Corb;
	@Column
	private Integer pi_Opcode;
	@Column
	private String pi_Stage;
	@Column
	private Integer pi_Week;
	@Column
	private Integer pi_Day;
	@Column
	private Integer pi_Shift;
	@Column
	private Double pi_Inoculation;
	@Column
	private Double pi_Bottles;
	@Column
	private String pi_Date;
	@Column
	private String pi_Time;
	@Column
	private Integer pi_prweek;
	@Column
	private Integer pi_prday;
	@Column
	private Integer pi_prshift;
	@Column
	private Integer pi_pryear;
	@Column
	private String pi_Branchcode;
	@Column
	private Integer pi_Scnopcode;
	@Column
	private Integer pi_PIR_No;
	@Column
	private Integer plant_loc;
}
