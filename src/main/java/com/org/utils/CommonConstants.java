...
public class CommonConstants {
	...
	public static final String CONTAMINATION_HEADER = "cn_Plantloc,Pgr_no,Rack_Code,Shelf_Code,Block_Code,cn_Branchcode,cn_Variety,cn_Corb,cn_Opcode,cn_Stage,cn_Week,cn_Day,cn_Shift,cn_Inoculation,cn_Nature,cn_Date,cn_Time,cn_prweek,cn_prday,cn_pryear,cn_Year";
